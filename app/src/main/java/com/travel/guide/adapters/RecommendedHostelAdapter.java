...
public class RecommendedHostelAdapter extends RecyclerView.Adapter<RecommendedHostelAdapter.MyViewHolder>{

    List<RecommendedResBean.DataItem> ItemList;
    ...
    public RecommendedHostelAdapter(Context context, List<RecommendedResBean.DataItem> ItemList, ItemClickListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.child_lay_recommended_hostel, parent, false);
