...
public class OfferPropertyListAdapter extends RecyclerView.Adapter<OfferPropertyListAdapter.MyViewHolder>{

    List<OfferResBean.DataItem.GrabNowItem> ItemList;
    ...
    public OfferPropertyListAdapter(Context context, List<OfferResBean.DataItem.GrabNowItem> ItemList, ItemClickListener listener) {
