...
import com.travel.guide.databinding.ChildLayMyBookingBinding;
...
public class MyBookingAdapter extends RecyclerView.Adapter<MyBookingAdapter.MyViewHolder>{
    ...
    public List<MyBookingsResBean.BookingsItem> ItemList;
    ...
    public MyBookingAdapter(Context context, List<MyBookingsResBean.BookingsItem> ItemList, boolean needToPayNow, ItemClickListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ViewDataBinding binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.child_lay_my_booking, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        ChildLayMyBookingBinding binding = (ChildLayMyBookingBinding) holder.getBinding();
