...
public class PropertyListAdapter extends RecyclerView.Adapter<PropertyListAdapter.MyViewHolder>{
    ...
    List<SearchByInsResBean.DataItem> ItemList;
    ...
    public PropertyListAdapter(Context context, List<SearchByInsResBean.DataItem> ItemList, ItemClickListener listener) {
