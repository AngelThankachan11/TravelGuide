...
public class PopularPropertyListAdapter extends RecyclerView.Adapter<PopularPropertyListAdapter.MyViewHolder>{

    List<HomeDataResBean.ServicePropertyItem> ItemList;
    private Context context;
    private PopularItemClickListener listener;

    public interface PopularItemClickListener{
        void OnPopularItemClicked(int position);
    }

    public PopularPropertyListAdapter(Context context, List<HomeDataResBean.ServicePropertyItem> ItemList, PopularItemClickListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.child_lay_property_list, parent, false);
